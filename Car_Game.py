...
gameDisplay = pygame.display.set_mode(
    (Game_width, Game_height), pygame.DOUBLEBUF | pygame.HWSURFACE, 32)
...
def GameLoop():
    ...
    Accelerate = Acceleration_Class(
        Acceleration, Start_Acceleration_Stop, Start_Acceleration, Top_Speed)
